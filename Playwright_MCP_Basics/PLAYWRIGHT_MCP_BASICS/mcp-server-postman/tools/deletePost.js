...
export const name = "deletePost";
export const title = "Delete Post";
export const description = "Handles the DELETE request.";
...
export const handler = async  (input) => {
  ...
  try {
    ...
    console.error(`Error in deletePost tool:`, error);
    return { content: [{ type: "text", text: `Error executing tool deletePost: ${error.message}` }], isError: true };
  }
}
