...
export const title = "Get All Users";
...
export const handler = async  (input) => {
  ...
  try {
    ...
    console.error(`Error in getAllUsers tool:`, error);
    return { content: [{ type: "text", text: `Error executing tool getAllUsers: ${error.message}` }], isError: true };
  }
}
