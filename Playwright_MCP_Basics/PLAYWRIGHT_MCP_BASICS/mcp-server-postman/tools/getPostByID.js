...
export const name = "getPostByID";
export const title = "Get Post by ID";
...
export const handler = async  (input) => {
  ...
  try {
    ...
    console.error(`Error in getPostByID tool:`, error);
    return { content: [{ type: "text", text: `Error executing tool getPostByID: ${error.message}` }], isError: true };
  }
}
