...
export const name = "getTodos";
export const title = "Get Todos";
...
export const handler = async  (input) => {
  ...
  try {
    ...
    console.error(`Error in getTodos tool:`, error);
    return { content: [{ type: "text", text: `Error executing tool getTodos: ${error.message}` }], isError: true };
  }
}
