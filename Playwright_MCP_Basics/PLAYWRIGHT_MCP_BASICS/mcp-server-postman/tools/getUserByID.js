...
export const name = "getUserByID";
export const title = "Get User by ID";
...
export const handler = async  (input) => {
  ...
  try {
    ...
    console.error(`Error in getUserByID tool:`, error);
    return { content: [{ type: "text", text: `Error executing tool getUserByID: ${error.message}` }], isError: true };
  }
}
